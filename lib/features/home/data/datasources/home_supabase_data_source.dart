...
part 'home_supabase_data_source.g.dart';

class HomeSupabaseDataSource {
  final SupabaseClient _client;

  HomeSupabaseDataSource(this._client);
...
@riverpod
HomeSupabaseDataSource homeSupabaseDataSource(HomeSupabaseDataSourceRef ref) {
  return HomeSupabaseDataSource(ref.watch(supabaseProvider));
}
